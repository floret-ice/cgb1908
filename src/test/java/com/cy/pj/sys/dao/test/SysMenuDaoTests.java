...
public class SysMenuDaoTests {
	...
	public void testFirstLevelCache() {
		...
		session1.close(); //session的一级缓存失效
		SqlSession session2 = sessionFactory.openSession();
		SysMenuDao dao = session2.getMapper(SysMenuDao.class);
		Map<String, Object> map3 = dao.findById(30);
		Map<String, Object> map4 = dao.findById(30);
		System.out.println(map3==map4);
		session2.close();
	}
	@Test 
	public void testSecondLevelCache() {
		Map<String, Object> map1 = sysMenuDao.findById(130);
		Map<String, Object> map2 = sysMenuDao.findById(130);
		System.out.println(map1==map2);
	}
	@Test 
